...
const DICT = {
  ...
  'set.stroke.help': { en: 'Adds a same-color stroke around each shape to seal hairline gaps. 0 removes strokes; 1 is the recommended starting point.', es: 'Agrega un borde del mismo color a cada forma para sellar rendijas finas. 0 quita los bordes; 1 es el punto recomendado.' },
  ...
  'set.traceScale.help': { en: 'Upscales the raster before quantizing and tracing. 2x gives smoother line-art at higher processing cost.', es: 'Escala el raster antes de cuantizar y trazar. 2x suaviza mejor el line-art con más costo de proceso.' },
